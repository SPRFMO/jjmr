...
#>   .. .. ..@ ptype: int(0) 
#>   .. ..- attr(*, ".drop")= logi TRUE
#>  $ index_fits       :'data.frame':   284 obs. of  9 variables:
#>   ..$ model           : chr [1:284] "h2_0.00" "h2_0.00" "h2_0.00" "h2_0.00" ...
#>   ..$ stock           : chr [1:284] "Stock_1" "Stock_1" "Stock_1" "Stock_1" ...
#>   ..$ index           : chr [1:284] "Obs_Survey_1" "Obs_Survey_1" "Obs_Survey_1" "Obs_Survey_1" ...
...
#>  $ selectivities    : tibble [13,596 × 9] (S3: tbl_df/tbl/data.frame)
...
#>   ..$ fleet_number: chr [1:13596] "1" "1" "1" "1" ...
